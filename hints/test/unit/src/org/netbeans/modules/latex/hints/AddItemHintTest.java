...
public class AddItemHintTest extends NbTestCase {
    ...
    private ErrorDescription computeHint(LaTeXParserResult lpr, int offset) throws Exception {
        ...
        while (n != null) {
            if (provider.accept(lpr, n)) {
                List<ErrorDescription> computed = provider.computeHints(lpr, n, offset);
    ...
    private void testPerformer(String code, final String[] fixesGolden, final String errorToFix, String golden) throws Exception {
        ...
        ParserManager.parse(Collections.singleton(s), new UserTask() {
            public void run(ResultIterator iterator) throws Exception {
                ...
                ErrorDescription error = computeHint(lpr, sourceOffset[0]);
