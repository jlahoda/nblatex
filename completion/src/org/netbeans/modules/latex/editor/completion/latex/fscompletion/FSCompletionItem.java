 ...
 */
package org.netbeans.modules.latex.editor.completion.latex.fscompletion;
            ...
            NbDocument.runAtomicAsUser(doc, new Runnable() {
                public void run() {
                    try {
                        ...
                        doc.remove(caretOffset - prefix.length(),
                                prefix.length());
                        doc.insertString(caretOffset - prefix.length(), valueFin, null);
